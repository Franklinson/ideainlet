"""
Django settings for ideainlet project.
...
SECRET_KEY = 'django-insecure-en3lt9_8lq-^luw8w0)lq3%76642qhy-o7y88*0aa(z%k39u5r'
...
WSGI_APPLICATION = 'ideainlet.wsgi.application'
...
#File Path
MEDIA_ROOT = 'abstract/static/images'
